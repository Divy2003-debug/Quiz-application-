...
public class Quiz extends JFrame implements ActionListener {
   ...
   Quiz(String name) {
      ...
      this.questions[0][0] = "Who invented Java Programming";
      this.questions[0][1] = "Guido van Rossum";
      this.questions[0][2] = " James Gosling";
      this.questions[0][3] = "Dennis Ritchie";
      this.questions[0][4] = "Bjarne Stroustrup";
      ...
      this.questions[2][0] = "Which statement is true about Java?";
      this.questions[2][1] = " Java is a sequence-dependent programming language";
      this.questions[2][2] = " Java is a code dependent programming language";
      this.questions[2][3] = " Java is a platform-dependent programming language";
      this.questions[2][4] = "Java is a platform-independent programming languagee";
      ...
      this.questions[9][0] = "Which of these cannot be used for a variable name in Java?";
      this.questions[9][1] = "identifier & keyword";
      this.questions[9][2] = "identifier";
      this.questions[9][3] = " keyword";
      this.questions[9][4] = "none of the mentioned";
      this.answers[0][1] = "James Gosling";
      this.answers[1][1] = "int";
      this.answers[2][1] = " Java is a platform-independent programming language";
